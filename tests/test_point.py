...
from aoc.point import Point, PointTypeElemType
...
def point_unary_operations(x: PointTypeElemType, y: PointTypeElemType) -> Point:
...
def point_binary_operations(
    x1: PointTypeElemType,
    y1: PointTypeElemType,
    x2: PointTypeElemType,
    y2: PointTypeElemType,
) -> None:
